...
class HandleRequests(http.server.BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(bytes("<html><head><title>First Application</title></head><body style='color: #333; margin-top: 30px;'><center><h2>Monitoring Conatiner Resource Utilization for Remediation on kubernetes.</center></h2></body></html>", "utf-8"))
        self.wfile.close()
